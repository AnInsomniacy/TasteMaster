...
struct ingredient_recognization: View{
                ...
                .padding()
                    ...
                    Button(action: {
                        ...
                        if let img = image {
                            currentTask = Task {
                                do {
                                    let jsonString = try await recognizeImage(image: img,itemType: "ingredient")
