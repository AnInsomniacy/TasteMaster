//
//  ItemIdentification.swift
//  TasteMaster
//
//  Created by Sekiro on 30/10/2023.
//
                ...
                VStack{
                    ...
                    Button(action: {
                        ...
                        if let img = image {
                            currentTask = Task {
                                do {
                                    let jsonString = try await recognizeImage(image: img,itemType: "advanced_general")
